...
fpath = "check_points/"  + model_name +  "/" + training_dir + "/" + model_name + "_{epoch:02d}_100" + ".hdf5"
...
model = load_model('check_points/unet20/UnetDataset_v4/unet20_20.hdf5', custom_objects=dependencies)
